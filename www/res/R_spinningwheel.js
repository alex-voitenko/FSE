 ...
 * Hacked by : Renelco @ Renelco SA - 2015.06.23
 * 
 */
...
var SpinningWheel = {
	...
	updateSelectedState: function (l) {
		...
		for (var i=0; i<ul.childNodes.length; i++){
			...
			var clName = '';
			// Added by Renelco: To prevent multiselect strange behaviour
			if(i==0) this.slotData[l].selectedValues[valueIndex] = false;	
			// Added by Renelco - End
